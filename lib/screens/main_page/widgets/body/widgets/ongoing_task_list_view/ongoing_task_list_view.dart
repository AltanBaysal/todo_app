...
class OngoingTaskListView extends StatelessWidget {
  const OngoingTaskListView({Key? key}) : super(key: key);
      ...
      children: [
        ...
        Selector<MainPageController, Tuple2<int, TaskSortingType>>(
          selector: (
            ...
            return Tuple2(value.tasks.withoutAchievedTask.length, value.taskSortingType);
          },
          builder: (
            BuildContext context,
            Tuple2 value,
            ...
            List<Task> taskList = context.providerOfMainPageController.tasks.withoutAchievedTask.inSelectedOrder(value.item2);
